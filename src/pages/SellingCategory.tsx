...
function SellingCategory() {
    return (
        <div>
            <div className="w-full lg:h-[800px] bg-yellow-300 md:text-2xl text-lg min-md:h-[1800px] ">
                ...
                <div className="flex lg:h-1/2 lg:flex-row flex-col max-sm:items-center">
                    <div className='lg:w-2/6 bg-blue-200 '>
                        <div className='mx-[8px]  lg:h-full bg-green-300 flex lg:flex-col justify-center items-center '>
                            ...
                            <button className='w-4/8 rounded-xl bg-purple-400 text-white lg:m-8 lg:p-[12px] p-[8px]   md:p-[24px] items-center lg:mr-0 lg:ml-0 md:mr-8 ml-auto'>Playstation</button>
                    ...
                    <div className='lg:w-2/6 bg-blue-200 '>
                        <div className='mx-[8px]  lg:h-full bg-green-300 flex lg:flex-col justify-center items-center'>
                            ...
                            <button className='w-4/8  rounded-xl bg-purple-400 text-white lg:m-8 lg:p-[12px] p-[8px] items-center md:p-[24px] items-center lg:mr-0 lg:ml-0 md:mr-8 ml-auto'>Tablets </button>
                    ...
                    <div className='lg:w-2/6 bg-blue-200 '>
                        <div className='mx-[8px]  lg:h-full bg-green-300 flex lg:flex-col justify-center items-center '>
                            ...
                            <button className='w-4/8  rounded-xl bg-purple-400 text-white lg:m-8 lg:p-[12px]  md:p-[24px] items-center p-[8px] items-center md:mr-8 ml-auto'>iPhones</button>
